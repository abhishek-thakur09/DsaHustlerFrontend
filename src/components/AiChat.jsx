...
const AIChat = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      const res = await api.post("/ai/aiInstructure", { message });

      console.log(res);
      // add AI reply
      setChat([...newChat, { role: "ai", text: res.data.hint }]);
    } catch (err) {
      console.log(err);
  ...
  return (
    <div className="p-5 max-w-xl mx-auto">
      <h2 className="text-blue-500 text-xl font-semibold mb-4">AI Assistant</h2>
      ...
      <div className="h-[400px] overflow-y-auto border-2 border-blue-500 p-3 mb-4 rounded-lg">
        ...
        {loading && <p className="text-blue-400 text-sm mt-2">thinking...</p>}
      </div>
